...
if [[ -z "${HOMEBREW_ON_LINUX-}" ]]; then
  ...
  HOMEBREW_CORE_DEFAULT_GIT_REMOTE="git@github.com/Homebrew/homebrew-core"
  ...
  HOMEBREW_CORE_DEFAULT_GIT_REMOTE="git@github.com/Homebrew/linuxbrew-core"
...
HOMEBREW_BREW_DEFAULT_GIT_REMOTE="git@github.com/Homebrew/brew"
